package com.meiku.dev.views.fab;
...
public class ButtonFloat extends Button {
	...
	public ButtonFloat(Context context, AttributeSet attrs) {
		...
		setBackgroundResource(R.drawable.sousuo);
		...
		LayoutParams params = new LayoutParams(Util.dpToPx(sizeIcon,
				getResources()), Util.dpToPx(sizeIcon, getResources()));
	...
	protected void setDefaultProperties() {
		rippleSpeed = Util.dpToPx(2, getResources());
		rippleSize = Util.dpToPx(5, getResources());
		setMinimumWidth(Util.dpToPx(sizeRadius * 2, getResources()));
		setMinimumHeight(Util.dpToPx(sizeRadius * 2, getResources()));
	...
	protected void setAttributes(AttributeSet attrs) {
		...
		// attrs.getAttributeBooleanValue(MATERIALDESIGNXML,"animate", false);
		// post(new Runnable() {
		//
		// @Override
		// public void run() {
		// showPosition = ViewHelper.getY(ButtonFloat.this) - Util.dpToPx(20,
		// getResources());
	...
	protected void onDraw(Canvas canvas) {
		...
		if (x != -1) {
			...
			Rect dst = new Rect(Util.dpToPx(1, getResources()), Util.dpToPx(2,
					getResources()), getWidth()
					- Util.dpToPx(1, getResources()), getHeight()
					- Util.dpToPx(2, getResources()));
	...
	public void show() {
		// ObjectAnimator animator = ObjectAnimator.ofFloat(ButtonFloat.this,
		// "y", showPosition);
