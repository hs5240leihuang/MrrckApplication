...
public class MyPullToRefreshScrollView extends ScrollView {
	...
	private RelativeLayout mParentView;// 布局的父布局，ScrollView内部只能有一个根ViewGroup，就是此View
	...
	public MyPullToRefreshScrollView(Context context, AttributeSet attrs) {
		...
		mTopViewHeight = ScreenUtil.dip2px(context, 180);
	}
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		if (scrollListener!=null) {
			scrollListener.scrollChange(l, t, oldl, oldt);
		}
	...
	public void addScrollChangeLiatener(ScrollListener scrollListener){
