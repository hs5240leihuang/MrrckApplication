...
public class TopTitle extends RelativeLayout {
	...
	public TopTitle(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(final Context context, AttributeSet attrs) {
		...
		if (null != attrs) {
			view = inflater.inflate(R.layout.top_title, this, true);
			...
			view.findViewById(R.id.goback).setOnClickListener(
					new OnClickListener() {
						@Override
						public void onClick(View v) {
							if (leftimg.getDrawable() != null) {
			...
			for (int k = 0; k < indexCount; k++) {
				...
				case R.styleable.TopTitle_right_txt_title:
					...
					if (!TextUtils.isEmpty(titleRight)) {
						...
						rightTxt.setTextColor(getResources().getColor(
								R.color.white));
						rightTxt.setPadding(10, 8, 10, 8);
