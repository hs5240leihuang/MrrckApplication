 ...
 * 
 */
public class AudioRecorderToMP3Util {
	/**
	 ...
	 * @param activity
	 */
	public AudioRecorderToMP3Util(Activity activity) {
	 ...
	 * @param mp3Path
	 */
	public AudioRecorderToMP3Util(Activity activity, String rawPath,
			String mp3Path) {
		this.activity = activity;
	 ...
	 */
	class Sample {
		AudioRecorderToMP3Util util = null;
		String mp3 = null;
		String raw = null;

		void start() {
			// util=new AudioRecorderToMP3Util(activity); 一般是用这个
			if (util == null)
				util = new AudioRecorderToMP3Util(null, "/sdcard/sample.raw",
						"/sdcard/sample.mp3");
