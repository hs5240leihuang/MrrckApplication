...
public class PlotterDetailActivity extends BaseActivity implements
		OnClickListener {
	...
	public void initValue() {
		...
		// webView.loadUrl("http://192.168.1.18:3000/view/plan/plan.html");
								...
								if (AppContext.getInstance()
									...
									if (!Tool.isEmpty(shareUrl)
										...
										new InviteFriendDialog(
												PlotterDetailActivity.this,
												shareUrl,
												shareTitle,
												shareContent,
												shareImg,
												shareJsonStr,
												ConstantKey.ShareStatus_PLOTPERSONDETAIL)
												.show();
									...
									ShowLoginDialogUtil
											.showTipToLoginDialog(PlotterDetailActivity.this);
								}
								break;
							// case 1:
							// if (AppContext.getInstance()
	...
	public void onClick(View arg0) {
		...
		case R.id.right_res_title:
			myPopupwindow.showAsDropDown(right_res_title,
					ScreenUtil.dip2px(PlotterDetailActivity.this, -80),
					ScreenUtil.dip2px(PlotterDetailActivity.this, 4));
			break;
	...
	private class MyWebViewClient extends WebViewClient {
		...
		public boolean shouldOverrideUrlLoading(WebView view, String url) {
			...
			if (url.contains("image_href")) {
				...
				case 1003:// 跳个人主页
					startActivity(new Intent(PlotterDetailActivity.this,
				...
				case 2018:
					...
					detailIntent.putExtra("loadUrl", map.get("loadUrl"));
					detailIntent.putExtra("shareUrl", map.get("shareUrl"));
					detailIntent.putExtra("shareImg", map.get("shareImg"));
					detailIntent.putExtra("shareContent",
							map.get("shareContent"));
					detailIntent.putExtra("shareTitle", map.get("shareTitle"));
					detailIntent.putExtra("userId",Integer.parseInt(map.get("userId")));
