 ...
 *
 * 类描述：简历邀请面试Entity
 * 类名称：com.mrrck.ap.rt.entity.JobInterviewEntity     
 * 创建人：仲崇生
 * 创建时间：2015-5-26 下午03:48:15   
 * @version V1.0
 */
public class JobInterviewEntity extends MkJobInterview{
	
	/**邀请面试简历表 jobInterviews*/
	private List<String> jobInterviewIds;
	...
	public List<String> getJobInterviewIds() {
		return jobInterviewIds;
	}

	public void setJobInterviewIds(List<String> jobInterviewIds) {
		this.jobInterviewIds = jobInterviewIds;
	}
	...
	public String getInterviewResultName() {
		return interviewResultName;
	}

	public void setInterviewResultName(String interviewResultName) {
		this.interviewResultName = interviewResultName;
	}
