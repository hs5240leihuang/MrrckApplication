...
import com.meiku.dev.yunxin.FileBrowserAdapter.FileManagerItem;
...
public class FileBrowserViewHolder extends TViewHolder{
    ...
    protected void inflate() {
        directoryBitmap = BitmapFactory.decodeResource(MrrckApplication.getInstance().getResources(),R.drawable.directory);
        fileBitmap = BitmapFactory.decodeResource(MrrckApplication.getInstance().getResources(), R.drawable.file);
