...
public abstract class MsgViewHolderThumbBase extends MsgViewHolderBase {
    ...
    private void refreshStatus() {
        ...
        if (message.getStatus() == MsgStatusEnum.sending
            ...
            progressLabel.setText(Util.getPercentString(getAdapter().getProgress(message)));
        } else {
    ...
    public static int getImageMaxEdge() {
        return (int) (165.0 / 320.0 * ScreenUtil.SCREEN_WIDTH);
    }

    public static int getImageMinEdge() {
        return (int) (76.0 / 320.0 * ScreenUtil.SCREEN_WIDTH);
    }
